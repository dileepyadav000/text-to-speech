...
def generate_audio(message: str,voice : str = "Brian"):
    ...
    headers = {'User-Agent':'Mozilla/5.0(Maciontosh;intel Mac OS X 10_15_7)AppleWebKit/537.36(KHTML,like Gecoko)Chrome/119.0.0. Safari/537.3'}
...
def speak(massage : str, voice: str = "Brian", folder: str = "", extension: str = ".mp3") ->Union[None,str]:
    try:
